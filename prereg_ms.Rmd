...
pronounced effect on the little brown bat, *Myotis lucifugus*, where
it's predicted that regional population collapse and extirpation could
occur as soon as within the next 16 years @frick2010a. Because WNS
affects bat species differentially, community-level monitoring studies
are needed to fully appreciate and mitigate consequences for community
structure and ecosystem function @hoyt2021. In 2021, the first instance
of *P. destructans* with no bat mortality was reported from the Cypress
Hills Interprovincial Park in Saskatchewan, Canada (Wilson pers. comm.,
...
We expect to see white-nose syndrome affect bat populations in Cypress
hill region of Saskatchewan Province (See Figure 1).

**Directional**: We expect to see population **declines** in little
brown bats (*Myotis lucifugus*) along with declines in most other bat
species within an infected community.

**Directional**: We expect to see an **increase** in silver-haired bats
(*Lasionycteris noctivagans*). (*Lasionycteris noctivagans*) and big
brown bats (*Eptesicus fuscus*) due to competitive release from other
declining bats within the community.
