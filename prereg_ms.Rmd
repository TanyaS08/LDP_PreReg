...
-Timing: between June-Aug from 1991-2030
-Every night that its not raining, wind over 20km/s
-Mist nets will be placed at different sites around Cypress Hills West Block
-Sites determined by previous capture sites to be consistent across years
-
...
no clear sample size, but
-40 yrs data, 3 months per year
-expect approx 100-200 captures per year,
-sample size 4000 indivs captured
